    ...
    <xsl:template match="body" mode="places">
       <xsl:variable name="place" select="//placeName"/>
            <xsl:for-each select="$place">
                ...
                <xsl:for-each select="ancestor::lg//placeName[not(. = current())] | ancestor::lg//rs[@type='place'][not (@subtype='language')][not(. = current())] | ancestor::lg//rs[@type='metaplace'][not(@subtype='simil')][not(. = current())] | ancestor::lg/preceding-sibling::lg//placeName[not(. = current())] | ancestor::lg/preceding-sibling::lg//rs[@type='place'][not (@subtype='language')][not(. = current())] | ancestor::lg/preceding-sibling::lg//rs[@type='metaplace'][not(@subtype='simil')][not(. = current())] | ancestor::lg/following-sibling::lg//placeName[not(. = current())] | ancestor::lg/following-sibling::lg//rs[@type='place'][not (@subtype='language')][not(. = current())] | ancestor::lg/following-sibling::lg//rs[@type='metaplace'][not(@subtype='simil')][not(. = current())]">
